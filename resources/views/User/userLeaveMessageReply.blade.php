...
@section('main')
    <p></p>
    <div class="mem_tit">
        <span class="fr" style="font-size:12px; color:#55555; font-family:'宋体'; margin-top:5px;">共发现{{ count($messages) }}条</span>我的回复
    </div>
    <table border="0" class="order_tab" style="width:930px;" cellspacing="0" cellpadding="0">
        ...
        @foreach($messages as $message)
            <tr>
                ...
                <td align="center"><a href="/product/detail_replay?product_id={{ $message['Product']['id'] }}&mes_id={{ $message['mes_id'] }}">查看详情</a>&nbsp; &nbsp;
                    &nbsp; &nbsp;
